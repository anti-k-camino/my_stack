  ...
  describe 'Create#patch' do
    context 'Authenticated user' do
      ...
      context 'valid attributes' do
        ...
        it 'changes question comments quantity' do       
          expect{ post :create, comment:{body: 'test'}, question_id: question, format: :js}.to change(question.comments, :count).by 1
        end      
      ...
      context 'invalid attributes' do
        ...
        it 'does not change question comments quantity' do
          expect{ post :create, comment:{ user: @user }, question_id: question, format: :js }.to_not change(question.comments, :count)
        end      
    ...
    context 'Non authenticated user' do
      ...
      it 'does not create a comment' do
        expect{ post :create, comment:{ body: "body"}, question_id: question, format: :js }.to_not change(question.comments, :count)
      end
